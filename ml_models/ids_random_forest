...
TEST_CSV      = "Your_own_capture_file.csv"
...
probabilities = model.predict_proba(test_df.values)[:, 1]

results_df = test_df.copy()
results_df["Is_Attack"]          = predictions
results_df["Attack_Probability"] = probabilities.round(4)

output_file = "detection_results_random_forest.csv"
